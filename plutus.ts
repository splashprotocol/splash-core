...
export interface IInstantOrderBatchWitness {
  new (): Validator;
  _: Data;
}

export const InstantOrderBatchWitness = Object.assign(
  function () {
    return {
      type: "PlutusV2",
      script:
        "",
    };
  },
  { _: { "title": "Data", "description": "Any Plutus data." } },
) as unknown as IInstantOrderBatchWitness;

export interface IInstantOrderInstantOrder {
  new (
    witness: {
      Inline: [
        { VerificationKeyCredential: [string] } | {
...
export const InstantOrderInstantOrder = Object.assign(
  function (
    witness: {
      Inline: [
        { VerificationKeyCredential: [string] } | {
    ...
    return {
      ...
      script: applyParamsToScript(
        applyDoubleCborEncoding(
          "",
        ),
        [witness],
        {
          "dataType": "list",
    ...
    conf: {
      ...
      "anyOf": [{
        ...
        "fields": [
          ...
          { "dataType": "bytes", "title": "permittedExecutors" },
          { "dataType": "integer", "title": "cancellationAfter" },
          { "dataType": "bytes", "title": "cancellationPkh" },
          { "dataType": "bytes", "title": "beacon" },
        ],
      }],
...
) as unknown as IInstantOrderInstantOrder;
...
export const LimitOrderBatchWitness = Object.assign(
  function () {
    return {
      type: "PlutusV2",
      script:
        "",
    };
  },
  { _: { "title": "Data", "description": "Any Plutus data." } },
...
export const LimitOrderLimitOrder = Object.assign(
  function (
    ...
    return {
      ...
      script: applyParamsToScript(
        applyDoubleCborEncoding(
          "",
        ),
        [witness],
        {
          "dataType": "list",
